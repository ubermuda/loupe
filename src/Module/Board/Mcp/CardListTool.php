...
final readonly class CardListTool implements FlagGatedToolInterface
{
     ...
     * @param string|null $type         only cards of this type: feature, bug, security, tooling, docs, idea, epic or site-review
