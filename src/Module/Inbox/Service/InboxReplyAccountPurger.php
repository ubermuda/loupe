...
final readonly class InboxReplyAccountPurger implements AccountDataPurgerInterface
{
    ...
    {
        $this->connection->executeStatement('DELETE FROM inbox_replies WHERE author_id = :user', ['user' => (string) $user->id]);
    }
}
