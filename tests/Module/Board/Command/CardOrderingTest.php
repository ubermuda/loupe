...
final class CardOrderingTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->deleteCard = new DeleteCardHandler($cards, $links, new CardGroupOrder($cards), new CardParentPolicy($cards), $this->em, SilentAuditor::create(), new EventDispatcher());
