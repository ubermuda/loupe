...
A dispatched agent inherits no instructions and no loaded skill. Before you touch a file, read the repository's `AGENTS.md` and follow it. Load each skill or instruction it names for the files you touch.
