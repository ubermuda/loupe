...
final class HeadingExtractorTest extends TestCase
{
    ...
    {
        $html = new MarkdownRenderer(new NullLogger(), new IdentityTranslator())->render("## Use `render()` *now*\n");
    ...
    public function test_labels_an_image_only_heading_from_its_alt_text(): void
    {
        ...
        $html = new MarkdownRenderer(new NullLogger(), new IdentityTranslator())->render("## ![System diagram](architecture.png)\n");
    ...
    {
        $html = new MarkdownRenderer(new NullLogger(), new IdentityTranslator())->render("## Request flow ![System diagram](architecture.png)\n");
    ...
    public function test_a_heading_whose_image_has_no_alt_text_yields_no_label(): void
    {
        ...
        $html = new MarkdownRenderer(new NullLogger(), new IdentityTranslator())->render("## ![](architecture.png)\n");
