...
use App\Tests\Support\McpSubjectResolver;
...
final class ResolvesBoundProjectTest extends KernelTestCase
{
    use McpTokenScenario;

    private EntityManagerInterface $em;
    private McpSubjectResolver $resolver;
    ...
    protected function setUp(): void
    {
        ...
        $projectResolver = self::getContainer()->get(AuthenticatedProjectResolver::class);
        self::assertInstanceOf(AuthenticatedProjectResolver::class, $projectResolver);
        ...
        $this->resolver = new McpSubjectResolver($projectResolver, $documents, $comments, $authorization);
    }
    ...
    public function test_resolves_a_comment_of_the_bound_project(): void
    {
        ...
        self::assertSame($comment, $this->resolver->comment((string) $comment->id));
    }
    ...
    public function test_an_unknown_comment_and_a_foreign_comment_are_rejected_identically(): void
    {
        ...
        $foreignMessage = null;
        try {
            $this->resolver->comment((string) $foreign->id);
        ...
        $unknownMessage = null;
        try {
            $this->resolver->comment($unknownId);
        } catch (ToolCallException $e) {
    ...
    public function test_an_unbound_token_is_rejected_before_the_comment_is_looked_up(): void
    {
        ...
        $this->resolver->comment((string) $comment->id);
    }
    ...
    public function test_resolves_a_document_of_the_bound_project(): void
    {
        ...
        self::assertSame($document, $this->resolver->document((string) $document->id));
    }
}
