...
final readonly class CardCreateTool implements FlagGatedToolInterface
{
     ...
     * @return CardSummary
     */
    public function __invoke(string $title, string $body, string $type, string $priority, ?string $status = null, ?string $origin = null, array $pullRequestUrls = [], array $documentIds = []): array
    {
