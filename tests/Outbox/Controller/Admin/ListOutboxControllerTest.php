...
namespace App\Tests\Outbox\Controller\Admin;
...
final class ListOutboxControllerTest extends WebTestCase
{
    public function test_admin_sees_undelivered_events_across_every_project(): void
    {
        ...
        $crawler = $client->request(Request::METHOD_GET, '/admin/outbox');
    ...
    public function test_the_project_filter_narrows_the_list(): void
    {
        ...
        $client->loginUser($admin);
        $crawler = $client->request(Request::METHOD_GET, '/admin/outbox?project='.$wanted->id);
    ...
    public function test_an_unknown_project_filter_widens_to_everything(): void
    {
        ...
        $client->loginUser($admin);
        $crawler = $client->request(Request::METHOD_GET, '/admin/outbox?project=not-a-uuid');
    ...
    public function test_a_logged_in_non_admin_gets_403(): void
    {
        ...
        $client->request(Request::METHOD_GET, '/admin/outbox');
