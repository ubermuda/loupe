...
final class SubmitReviewHandlerTest extends KernelTestCase
{
    ...
    {
        $site = $this->site('submit-a@example.com');
        ...
        $result = ($this->handler)(new SubmitReviewCommand($site));
    ...
    {
        $site = $this->site('submit-d@example.com');
        $review = new SiteReview($site);
