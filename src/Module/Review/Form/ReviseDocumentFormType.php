...
final class ReviseDocumentFormType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        if ($this->workLinks->isEnabled()) {
            $builder->add('workLinkIds', ChoiceType::class, [
                'label' => 'review.form.revise_document_form.work_links.label',
                'help' => 'review.form.revise_document_form.work_links.help',
                'required' => false,
                'multiple' => true,
                'expanded' => true,
    ...
    {
        $resolver->setDefaults(['data_class' => ReviseDocumentRequest::class, 'document' => null]);
