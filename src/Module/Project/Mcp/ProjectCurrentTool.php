...
use App\Module\Project\Command\ShowCurrentProjectCommand;
use App\Module\Project\Command\ShowCurrentProjectHandler;
...
final readonly class ProjectCurrentTool
{
    ...
    public function __construct(
        private ShowCurrentProjectHandler $showCurrentProject,
    ...
    {
        try {
            $view = ($this->showCurrentProject)(new ShowCurrentProjectCommand($this->requireBoundProject($this->projectResolver)));
