...
class AccountDeletionEmailSender
{
    ...
    public function send(User $user): void
    {
        ...
        $email = new TemplatedEmail()
            ...
            ->to($user->email)
            ->subject($this->translator->trans('account.email.account_deletion.subject'))
            ->htmlTemplate('@Account/email/account_deletion.html.twig')
            ->context(['confirmUrl' => $confirmUrl]);
