...
/**
 * @extends Voter<'site_review_comment.resolve'|'site_review_comment.reopen'|'site_review_comment.attach'|'site_review_comment.reply', SiteReviewComment>
 */
final class SiteReviewCommentVoter extends Voter
{
    ...
    public const string REPLY = 'site_review_comment.reply';
