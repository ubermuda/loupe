 ...
 *
 * $priority is null in a terminal column, which grades nothing and keeps its
 * cards in one run ordered by completion. Every other column has one group per priority, and
