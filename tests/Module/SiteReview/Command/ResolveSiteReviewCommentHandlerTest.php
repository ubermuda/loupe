...
final class ResolveSiteReviewCommentHandlerTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->handler = new ResolveSiteReviewCommentHandler($this->em, $this->audit->auditor, new EventDispatcher());
    }
    ...
    public function test_a_resolved_comment_is_recorded_on_the_domain_channel(): void
    {
        ...
        self::assertSame(['site_review.comment_resolved'], $this->audit->domainLogLines());
