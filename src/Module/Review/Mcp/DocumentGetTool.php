 ...
 */
#[McpTool(name: 'document_get', description: 'Fetch a document\'s current Markdown source, title, search language, status, archive state and reason, version number, that version\'s description, and the documents it references.')]
