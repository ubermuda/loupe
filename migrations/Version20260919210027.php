...
final class Version20260919210027 extends AbstractMigration
{
    #[\Override]
    public function getDescription(): string
    {
        return 'Drop the site review replies table with the feedback reply feature';
    }

    public function up(Schema $schema): void
    {
        // @contract-phase: the site-review reply is removed in this release, so no code reads or writes site_review_replies.
        $this->addSql('DROP TABLE IF EXISTS site_review_replies');
    }
