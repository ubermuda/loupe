...
final class Version20260912235455 extends AbstractMigration
{
     ...
     * reads status one last time, so SET NOT NULL fails only on a row whose
     * status names no column of its project.
     *
     * @contract-phase: the previous release stopped mapping status, so no deployed image reads or writes it
     */
    #[\Override]
