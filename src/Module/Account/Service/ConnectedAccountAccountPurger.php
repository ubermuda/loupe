...
final readonly class ConnectedAccountAccountPurger implements AccountDataPurgerInterface
{
    ...
    public function purge(User $user, AccountDeletionCleanup $cleanup): void
    {
        ...
        $this->em->getConnection()->executeStatement('DELETE FROM connected_accounts WHERE user_id = :id', ['id' => $id]);
    }
}
