...
final readonly class CardCreateTool implements FlagGatedToolInterface
{
     ...
     * @param string|null $status          the slug of the column the card lands in; defaults to the board's default column
