 ...
 * A length counts characters as sent, before any trim, the way the MCP SDK checks the schema.
 */
final class InboxLimits
{
    ...
    /** Per option. An inbox_list row carries every option. */
    ...
    /** Measured as sent, and again after a later call appends its context to the open ask. */
