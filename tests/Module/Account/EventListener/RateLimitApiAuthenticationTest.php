...
final class RateLimitApiAuthenticationTest extends TestCase
{
    ...
    public function test_the_peek_spends_nothing_under_the_production_policy(): void
    {
        ...
        for ($i = 0; $i < 10; ++$i) {
            $listener($this->arriving('/api/projects', '203.0.113.7', method: Request::METHOD_GET));
        }

        $listener->chargeFailure($this->failure('/api/projects', '203.0.113.7', method: Request::METHOD_GET));
