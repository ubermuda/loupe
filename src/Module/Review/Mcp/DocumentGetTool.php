 ...
 */
#[McpTool(name: 'document_get', description: 'Fetch a document\'s current Markdown source, title, status, archive state, version number, that version\'s description, and the documents it references.')]
