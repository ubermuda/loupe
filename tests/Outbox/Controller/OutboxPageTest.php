...
final class OutboxPageTest extends WebTestCase
{
    public function test_the_owner_sees_only_what_is_still_owed_to_the_agent(): void
    {
        ...
        $crawler = $client->request(Request::METHOD_GET, '/projects/'.$project->id.'/outbox');
    ...
    public function test_a_stranger_cannot_read_another_projects_outbox(): void
    {
        ...
        $client->request(Request::METHOD_GET, '/projects/'.$project->id.'/outbox');
