...
final readonly class ListTerminalColumnCardsHandler
{
    ...
    public function __invoke(ListTerminalColumnCardsCommand $command): ListTerminalColumnCardsView
    {
        ...
        return new ListTerminalColumnCardsView(
