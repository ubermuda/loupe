...
final class Version20260914160424 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE bridges (id UUID NOT NULL, projects JSON NOT NULL, cli_version VARCHAR(100) NOT NULL, last_seen_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, owner_id UUID NOT NULL, PRIMARY KEY (owner_id, id))');
