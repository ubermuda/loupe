...
A dispatched agent inherits no instructions and no loaded skill. Before you touch a file, read the instruction files of the repository, such as `AGENTS.md` or `AGENTS.md`, and follow them. Load each skill or instruction they name for the files you touch.
